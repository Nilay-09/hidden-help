      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-xl bg-zinc-900/50 border border-zinc-800 px-4 py-3.5
                   ...
                   focus:outline-none focus:ring-2 focus:ring-sky-500/40 pr-5"
          required
        >
          <option className="bg-zinc-900" value="">Select type</option>
          {REPORT_TYPES.map((type) => (
            <option className="bg-zinc-900" key={type} value={type}>
              {type}
            </option>
          ))}
        </select>
